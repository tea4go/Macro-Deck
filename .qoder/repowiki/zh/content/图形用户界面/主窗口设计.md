...
```mermaid
graph TB
MW["MainWindow<br/>主窗口"] --> NAV["导航栏<br/>contentButtonPanel"]
...
图表来源
- [MainWindow.Designer.cs:58-365](file://src/MacroDeck/GUI/MainWindow.Designer.cs#L58-L365)
...
章节来源
- [MainWindow.Designer.cs:58-365](file://src/MacroDeck/GUI/MainWindow.Designer.cs#L58-L365)
- [MainWindow.Designer.cs:340-351](file://src/MacroDeck/GUI/MainWindow.Designer.cs#L340-L351)
- [MainWindow.Designer.cs:162](file://src/MacroDeck/GUI/MainWindow.Designer.cs#L162)
...
## 结论
MainWindow 作为 Macro-Deck 的核心界面，通过清晰的导航与视图切换机制、完善的事件驱动模型、以及与通知、更新、设备、插件等系统的紧密集成，提供了稳定且可扩展的主界面体验。其在安全模式下的保护措施、多显示器适配与性能优化，进一步提升了可靠性与可用性。后续可在以下方面持续改进：更细粒度的状态持久化、更丰富的主题与可访问性支持、以及对更高 DPI 与多屏场景的进一步优化。