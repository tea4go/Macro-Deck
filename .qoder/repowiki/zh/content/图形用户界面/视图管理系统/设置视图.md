...
- 设置分类与实现：通用设置（启动、行为、语言）、网络设置（端口、SSL、ADB）、更新与备份、关于信息。
...
## 项目结构
设置视图位于主窗口的多标签页视图中，采用垂直导航标签页组织不同设置类别，各设置项通过 WinForms 控件绑定到全局配置对象，并在变更时持久化到 JSON 配置文件。
...
- [SelfSignedCertificateGenerator.cs:9-66](file://src/MacroDeck/Utils/SelfSignedCertificateGenerator.cs#L9-L66)
...
- 生效策略：部分设置即时生效（如错误上报开关），部分需要重启（端口、SSL）。
...
图表来源
- [SettingsView.cs:73-388](file://src/MacroDeck/GUI/MainWindowViews/SettingsView.cs#L73-L388)
...
- [SettingsView.cs:137-149](file://src/MacroDeck/GUI/MainWindowViews/SettingsView.cs#L137-L149)
...
图表来源
- [SettingsView.cs:329-386](file://src/MacroDeck/GUI/MainWindowViews/SettingsView.cs#L329-L386)
...
章节来源
- [SettingsView.cs:111-123](file://src/MacroDeck/GUI/MainWindowViews/SettingsView.cs#L111-L123)
...
- [SettingsView.cs:306-315](file://src/MacroDeck/GUI/MainWindowViews/SettingsView.cs#L306-L315)
- [UpdateService.cs:51-85](file://src/MacroDeck/Services/UpdateService.cs#L51-L85)
- [BackupManager.cs:224-267](file://src/MacroDeck/Backup/BackupManager.cs#L224-L267)

章节来源
- [SettingsView.cs:104-109](file://src/MacroDeck/GUI/MainWindowViews/SettingsView.cs#L104-L109)
- [SettingsView.cs:158-163](file://src/MacroDeck/GUI/MainWindowViews/SettingsView.cs#L158-L163)
- [SettingsView.cs:224-262](file://src/MacroDeck/GUI/MainWindowViews/SettingsView.cs#L224-L262)
- [SettingsView.cs:306-315](file://src/MacroDeck/GUI/MainWindowViews/SettingsView.cs#L306-L315)
- [BackupManager.cs:270-305](file://src/MacroDeck/Backup/BackupManager.cs#L270-L305)
...
- [SettingsView.cs:264-268](file://src/MacroDeck/GUI/MainWindowViews/SettingsView.cs#L264-L268)
...
- [SettingsView.cs:346-355](file://src/MacroDeck/GUI/MainWindowViews/SettingsView.cs#L346-L355)
