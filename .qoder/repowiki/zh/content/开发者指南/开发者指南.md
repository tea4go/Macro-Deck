...
## 更新摘要
**所做更改**
- 新增完整的 GitHub Actions CI/CD 流程说明，包括三个核心工作流文件的详细解释
- 补充已删除的五个工作流文件的历史背景和替代方案说明
- 增强社区 fork 环境下 CI/CD 流程的理解和使用指导
- 完善 CI/CD 限制和替代方案的重要背景信息
- 更新本地构建自动化系统章节，反映 CI 工作流的实际配置
...
**更新** 新增完整的 GitHub Actions CI/CD 流程说明，包括三个核心工作流文件的详细解释，以及社区 fork 环境下的 CI/CD 使用指导。特别感谢 CI 工作流的完善配置，为项目的持续集成提供了可靠的自动化基础。
...
- [update-macrodeck-local.ps1:1-122](file://update-macrodeck-local.ps1#L1-L122)
...
participant PS as "PowerShell 脚本<br/>中文本地化"
...
- [update-macrodeck-local.ps1:29-30](file://update-macrodeck-local.ps1#L29-L30)
- [.github/workflows/ci.yml:13-17](file://.github/workflows/ci.yml#L13-L17)
...
## 结论
本指南总结了 Macro-Deck 的开发与发布全链路：从 IDE 风格、构建与测试，到插件 API 使用、安装包生成与发布分类，再到新增的本地构建自动化系统、端到端冒烟测试和完整的 CI/CD 流程。新引入的 GitHub Actions 工作流提供了强大的自动化构建和测试能力，而增强的文档基础设施确保了测试流程的可追溯性和可维护性。
