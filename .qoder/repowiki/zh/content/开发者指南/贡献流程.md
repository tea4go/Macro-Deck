...
- [.github/workflows/ci.yml:1-19](file://.github/workflows/ci.yml#L1-L19)
...
- CI/自动化
  - CI 工作流：对非 main/production 分支 push 触发测试工作流
...
- [.github/workflows/ci.yml:1-19](file://.github/workflows/ci.yml#L1-L19)
- [.github/workflows/tests.yml:1-19](file://.github/workflows/tests.yml#L1-L19)
- [.github/workflows/create-release.yml:1-73](file://.github/workflows/create-release.yml#L1-L73)
- [.github/workflows/release-created.yml:1-53](file://.github/workflows/release-created.yml#L1-L53)
- [.github/ISSUE_TEMPLATE/bug_report.md:1-31](file://.github/ISSUE_TEMPLATE/bug_report.md#L1-L31)
- [.github/ISSUE_TEMPLATE/feature_request.md:1-21](file://.github/ISSUE_TEMPLATE/feature_request.md#L1-L21)
...
- [.github/workflows/tests.yml:1-19](file://.github/workflows/tests.yml#L1-L19)
- [.github/workflows/release-created.yml:1-53](file://.github/workflows/release-created.yml#L1-L53)
- [.github/workflows/build-push-windows.yml:1-91](file://.github/workflows/build-push-windows.yml#L1-L91)
- [.github/workflows/publish-nuget.yml:1-60](file://.github/workflows/publish-nuget.yml#L1-L60)
...
- 合并前要求
  - 通过 CI 测试（Windows Runner 上执行 dotnet test）
  - 代码清晰、注释完整、遵循项目风格
  - 无重大冲突，必要时进行 rebase 或 merge
- 合并分支
  - main：用于热修复与小版本更新
  - production：用于稳定版本发布
  - 非 main/production 分支 push 将触发 CI 测试

章节来源
- [.github/workflows/ci.yml:3-18](file://.github/workflows/ci.yml#L3-L18)
...
## 结论
通过明确的分支策略、严格的测试与发布流程、标准化的 Issue 模板与标签体系，以及清晰的社区沟通规范，Macro-Deck 为贡献者提供了高效、透明且可持续的协作体验。建议新贡献者从 Issue 与文档入手，逐步参与 PR 评审与发布流程，最终成长为正式维护者。
